...
function UserListScreen(props) {
    ...
    const {loading:loadingDelete , error:errorDelete , success:succesDelete} = userDelete;
  ...
  return (
    <div>
      ...
      {succesDelete && <MessageBox variant='success'>User Deleted Succesfully</MessageBox>}
      {loading ? (
