...
export const userListReducers = (state = {loading:true},action)=>{
  switch(action.type){
...
export const userTopSellerListReducers = (state = {loading:true},action)=>{
  switch(action.type){
